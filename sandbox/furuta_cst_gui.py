...
class FurutaPIDFrame(wx.Frame):
    ...
    def _start_control(self):
        ...
        for tc in (self._kp, self._ki, self._kd, self._adz,
                   ...
                   self._ks, self._kb, self._kv, self._torque_lim):
            tc.Disable()
        if self._no_swing:
        ...
        self._ctrl_thread = threading.Thread(
            ...
            args=(kp, ki, kd, adz, bi, kt, kf, pdz, tmax, ks, kb, kv, torque_lim),
            daemon=True)
    ...
    def _control_loop(self, kp, ki, kd, adz, bi, kt, kf, pdz, tmax, ks, kb, kv, torque_lim):
        # ── Parameter reference ───────────────────────────────────────────
        #
        ...
        #   T = pump · fraction · (Ks if de<0 else Kb)
