...
TORQUE_LIM_SWING_DEFAULT = 2000  # [torque units] output clamp during swingup/braking
TORQUE_LIM_BAL_DEFAULT   = 1000  # [torque units] output clamp during balance
DISABLE_TEMP        = 85
...
class FurutaPIDFrame(wx.Frame):
    ...
    def __init__(self):
        super().__init__(None, title="Furuta Pendulum Controller  [CST]", size=(920, 520))
